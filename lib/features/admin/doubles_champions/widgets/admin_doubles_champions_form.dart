...
import '../controller/admin_doubles_champions_controller.dart';
import '../model/admin_doubles_champions_entry.dart';

class AdminDoublesChampionForm extends StatefulWidget {
  final AdminDoublesChampionEntry? existing;

  const AdminDoublesChampionForm({super.key, this.existing});

  @override
  State<AdminDoublesChampionForm> createState() =>
      _AdminDoublesChampionFormState();
}

class _AdminDoublesChampionFormState extends State<AdminDoublesChampionForm> {
  ...
  late final AdminDoublesChampionsController controller;
  int _division = 1;
  ...
  void _save() async {
    final entry = AdminDoublesChampionEntry(
